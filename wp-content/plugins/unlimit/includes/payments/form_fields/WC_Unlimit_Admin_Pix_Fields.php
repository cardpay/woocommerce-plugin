...
class WC_Unlimit_Admin_Pix_Fields extends WC_Unlimit_Alt_Admin_Fields {

	public const FIELDNAME_PREFIX = 'woocommerce_unlimit_pix_';
	public const PIX_TITLE = 'Pix - Unlimit';
