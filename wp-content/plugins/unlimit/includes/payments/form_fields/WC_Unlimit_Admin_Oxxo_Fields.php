...
class WC_Unlimit_Admin_Oxxo_Fields extends WC_Unlimit_Alt_Admin_Fields {

	public const FIELDNAME_PREFIX = 'woocommerce_unlimit_oxxo_';
	public const SPEI_TITLE = 'OXXO - Unlimit';
